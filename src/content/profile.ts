...
export const tools: Tool[] = [
  ...
  { name: "Groq", category: "AI/LLM", icon: "groq" },
  { name: "Gemini", category: "AI/LLM", icon: "googlegemini" },
  { name: "Claude", category: "AI/LLM", icon: "anthropic" },
  { name: "ChromaDB", category: "AI/LLM", icon: "chromadb" },
  { name: "Cursor", category: "AI Coding", icon: "cursor" },
  { name: "Claude Code", category: "AI Coding", icon: "anthropic" },
  { name: "Gemini CLI", category: "AI Coding", icon: "googlegemini" },
  { name: "OpenCode", category: "AI Coding", icon: "opencode" },
  { name: "Hermes Agent", category: "AI Coding", icon: "hermes" },
  { name: "Docker", category: "Backend/Infra", icon: "docker" },
  { name: "Git", category: "Backend/Infra", icon: "git" },
  { name: "Google Cloud", category: "Backend/Infra", icon: "googlecloud" },
  ...
  { name: "MQL5", category: "Bahasa", icon: "mql5" },
  ...
  { name: "GDScript", category: "Game", icon: "gdscript" },
  { name: "GSAP", category: "3D/Anim", icon: "gsap" },
  { name: "Spline", category: "3D/Anim", icon: "spline" },
];
